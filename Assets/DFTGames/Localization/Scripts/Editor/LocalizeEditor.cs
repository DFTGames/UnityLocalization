...
// File: LocalizeEditor.cs
// Summary: Custom inspector for Localize component
//
...
{
    /// <summary>
    /// Custom Unity Editor inspector for the Localize component.
    /// Provides a branded header and enhanced editor interface for managing
    /// text localization settings in the Unity Inspector.
    /// 
